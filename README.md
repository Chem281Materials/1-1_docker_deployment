...
Note that the normal way to run a MOPAC input file is “`mopac <file_name>.mop`”.
...
Put all of your files (including your Containerfile, entrypoint script, test input file, etc.) in this GitHub repository.
